...
aut aut aut maxime quia temporibus ut omnis`}],Pc=({user:e})=>e?V.jsxs("div",{className:"UserInfo","data-cy":"UserInfo",children:[V.jsx("span",{className:"UserInfo__name",children:e.name})," ",V.jsx("a",{className:"UserInfo__email",href:`mailto:${e.email}`,children:e.email})]}):null,Lc=({comment:e})=>V.jsxs("div",{className:"CommentInfo",children:[V.jsx("p",{className:"CommentInfo__name",children:e.name}),V.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email}),V.jsx("p",{className:"CommentInfo__body",children:e.body})]}),Tc=({comments:e=[]})=>e.length?V.jsx("div",{className:"CommentList",children:e.map(t=>V.jsx(Lc,{comment:t},t.id))}):V.jsx("p",{className:"CommentList__no-comments","data-cy":"NoCommentsMessage",children:"No comments yet"}),Mc=({post:e})=>V.jsxs("article",{className:"PostInfo",children:[V.jsx("h2",{className:"PostInfo__title",children:e.title}),V.jsx("p",{className:"PostInfo__body",children:e.body}),V.jsx(Pc,{user:e.user}),V.jsx(Tc,{comments:e.comments})]}),Rc=({posts:e})=>V.jsx("section",{className:"PostList",children:e.map(t=>V.jsx(Mc,{post:t},t.id))});function Dc(e){return zc.find(t=>t.id===e)||null}function jc(e){return Nc.filter(t=>t.postId===e)}const Oc=Cc.map(e=>({...e,user:Dc(e.userId),comments:jc(e.id)})),Fc=()=>V.jsxs("div",{className:"App",children:[V.jsx("h1",{className:"App__title",children:"Static list of posts"}),V.jsx(Rc,{posts:Oc})]});em(document.getElementById("root")).render(V.jsx(Fc,{}));
