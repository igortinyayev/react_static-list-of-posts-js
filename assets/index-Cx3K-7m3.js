...
expedita consequatur consequatur dolores quia eos et placeat`}],zc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Nc=[{postId:1,id:1,name:"id labore ex et quam laborum",email:"Eliseo@gardner.biz",body:`laudantium enim quasi est quidem magnam voluptate ipsam eos
...
aut aut aut maxime quia temporibus ut omnis`}],Pc=({user:e})=>W.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Lc=({comment:e})=>W.jsxs("div",{className:"CommentInfo",children:[W.jsx("p",{className:"CommentInfo__name",children:e.name}),W.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email}),W.jsx("p",{className:"CommentInfo__body",children:e.body})]}),Tc=({comments:e=[]})=>e.length===0?W.jsx("p",{className:"CommentList__no-comments","data-cy":"NoCommentsMessage",children:"No comments yet"}):W.jsx("div",{className:"CommentList",children:e.map(t=>W.jsx(Lc,{comment:t},t.id))}),Mc=({post:e})=>W.jsxs("article",{className:"PostInfo",children:[W.jsx("h2",{className:"PostInfo__title",children:e.title}),W.jsx("p",{className:"PostInfo__body",children:e.body}),W.jsx(Pc,{user:e.user}),W.jsx(Tc,{comments:e.comments})]}),Rc=({posts:e})=>W.jsx("section",{className:"PostList",children:e.map(t=>W.jsx(Mc,{post:t},t.id))});function Dc(e){return zc.find(t=>t.id===e)||null}function jc(e){return Nc.filter(t=>t.postId===e)}const Oc=Cc.map(e=>({...e,user:Dc(e.userId),comments:jc(e.id)})),Fc=()=>W.jsxs("div",{className:"App",children:[W.jsx("h1",{className:"App__title",children:"Static list of posts"}),W.jsx(Rc,{posts:Oc})]});em(document.getElementById("root")).render(W.jsx(Fc,{}));
